...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.whale.sell.*.controller.Seller*.*(..))" +
    "&& !execution(public * com.whale.sell.auth.controller.SellerUserController.*(..))")
    public void verify() {}
